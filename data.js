...
const MOS_BY_BRANCH = {
  'Army': [
    ...
    {code:'12B',label:'Combat Engineer',noise:'High',tera:true,notes:'Frequent demolitions and blast exposure. Elevated TBI and PTSD risk. Physical demands produce significant musculoskeletal injury.'},
    {code:'13B',label:'Cannon Crewmember',noise:'Very High',tera:true,notes:'Artillery produces some of the highest noise levels in the military. Tinnitus and hearing loss are near-universal. Concussive blast overpressure is a significant TBI risk.'},
    {code:'13F',label:'Fire Support Specialist',noise:'High',tera:true,notes:'Forward observer role combines extreme artillery noise with direct combat exposure. Tinnitus, hearing loss, and PTSD are extremely common.'},
    ...
    {code:'88M',label:'Motor Transport Operator',noise:'Moderate-High',tera:true,notes:'Significant spinal injury from heavy vehicle operations on rough terrain. IED exposure on supply routes creates major PTSD and TBI risk.'},
    {code:'89D',label:'EOD Specialist',noise:'High',tera:true,notes:'Extreme blast exposure from EOD operations. Very high TBI rates. Among the highest-risk MOSs for blast injury and PTSD.'},
    {code:'91B',label:'Wheeled Vehicle Mechanic',noise:'Moderate-High',tera:true,notes:'Diesel exhaust and hydraulic fluid exposure. Significant musculoskeletal stress from mechanical work. Hearing loss from engine noise.'},
    {code:'92A',label:'Automated Logistical Specialist',noise:'Moderate',tera:true,notes:'Deployed supply specialists often work in areas with significant burn pit exposure from logistics hubs in Iraq and Afghanistan.'},
